...
public class SMSMacro {
	...
	public static Boolean hasMacro(String macro) {
		return !cmdSet.getStringList(macro, null).isEmpty();
	}
...
//			// TODO: this is really ugly, but temporary
//			Plugin plugin = Bukkit.getServer().getPluginManager().getPlugin("ScrollingMenuSign");
//			ReturnStatus rs = new CommandParser((ScrollingMenuSign)plugin).runCommandString(player, command);
//			switch (rs) {
//			case NO_PERMS:
