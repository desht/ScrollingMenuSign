package me.desht.register.payment;
...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new me.desht.register.payment.methods.iCo6());
        addMethod("iConomy", new me.desht.register.payment.methods.iCo5());
        addMethod("iConomy", new me.desht.register.payment.methods.iCo4());
        addMethod("BOSEconomy", new me.desht.register.payment.methods.BOSE6());
        addMethod("BOSEconomy", new me.desht.register.payment.methods.BOSE7());
        addMethod("Essentials", new me.desht.register.payment.methods.EE17());
        addMethod("Currency", new me.desht.register.payment.methods.MCUR());
